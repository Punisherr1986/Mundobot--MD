...
//if (settingsREAD.autoread2 == 'true') await this.readMessages([m.key]);
 ...
 if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|s|a|and|but|ify|naufrazapp|bot|saku|bug|syntax)/gi)) {
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: packname, body: wm, thumbnail: imagen6, sourceUrl: 'https://whatsapp.com/channel/0029VaRibRvDuMRj6ozMSN1l'}}}}, aa);
