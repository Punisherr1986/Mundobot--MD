...
this.sendMessage(m.chat, {text: `No tienes suficientes monedas para usar este comando.`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: packname, previewType: 0, thumbnail: menusImgs4, sourceUrl: channel }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `No tienes suficientes diamantes, compra con el comando: ${usedPrefix}buy`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: packname, previewType: 0, thumbnail: menusImgs4, sourceUrl: channel }}}, { quoted: m })         
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `Se requiere el nivel: *${plugin.level}*\nTu nivel actual es: *${_user.level}*\n\nPuedes subir de nivel usando el comando: *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: packname, previewType: 0, thumbnail: menusImgs4, sourceUrl: channel }}}, { quoted: m })         
...
if (m.limit)
m.reply(`Gastaste: ${m.limit} Diamante(s)`)
}
if (m.money)
m.reply(`Gastaste: ${m.money} Moneda(s)`)  
break
}}} catch (e) {
console.error(e)
} finally {
...
this.sendMessage(id, { text:`*❌ LOS NUMEROS RAROS NO SE PERMITEN EN ESTE GRUPO, SERAS ELIMINADO.*`, mentions: [user] }, { quoted: null });          
...
"thumbnail": apii.data, 
"title": [wm, ' 👋🏻 Buenasssss!!! ', ' Unete a mi canal de WhatsApp'].getRandom(),
...
if (nk.isGroup == false) {
if (nk.status == "offer") {
let callmsg = await this.reply(nk.from, `👋🏻 Hola usuarios: *@${nk.from.split('@')[0]}*, ${nk.isVideo ? 'las llamadas' : 'las video llamadas'} no estan permitidos, seras bloqueado.\n\n• Si es un error, contacta con el creador: ${creador}`, false, { mentions: [nk.from] })
...
• Reenviando mensaje eliminado...`.trim();
...
let msg = {
    rowner: '『👑』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 𝙙𝙚𝙡 𝙗𝙤𝙩.',
    owner: '『👑』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙗𝙤𝙩𝙨 𝙤𝙛𝙞𝙘𝙞𝙖𝙡𝙚𝙨 𝙮 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧.',
    mods: '『🪄』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙡𝙤𝙨 𝙢𝙤𝙙𝙚𝙧𝙖𝙙𝙤𝙧𝙚𝙨.',
    premium: '『🏆』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙡𝙤𝙨 𝙪𝙨𝙪𝙖𝙧𝙞𝙤𝙨 𝙥𝙧𝙚𝙢𝙞𝙪𝙢.',
    group: '『👥』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙚𝙣 𝙘𝙝𝙖𝙩𝙨 𝙜𝙧𝙪𝙥𝙖𝙡𝙚𝙨.',
    private: '『👤』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙚𝙣 𝙘𝙝𝙖𝙩𝙨 𝙥𝙧𝙞𝙫𝙖𝙙𝙤𝙨.',
    admin: '『💯』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙗𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙡𝙤𝙨 𝙖𝙙𝙢𝙞𝙣𝙨 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤.',
    botAdmin: '『🤖』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙛𝙪𝙣𝙘𝙞𝙤𝙣𝙖 𝙨𝙞 𝙚𝙡 𝙗𝙤𝙩 𝙚𝙨 𝙖𝙙𝙢𝙞𝙣.',
    unreg: '『🌌』𝙋𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙩𝙞𝙚𝙣𝙚 𝙦𝙪𝙚 𝙧𝙚𝙜𝙞𝙨𝙩𝙧𝙖𝙧𝙨𝙚.\n\n\`#reg Nombre.Edad\`\n\n𝙀𝙅𝙀𝙈𝙋𝙇𝙊:\n\`#reg Naufrago 19\`',
    restrict: '『💾』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙨𝙩𝙖 𝙙𝙚𝙨𝙖𝙘𝙩𝙞𝙫𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧.',
}[type]
//if (msg) return m.reply(msg)
let tg = { quoted: m, userJid: conn.user.jid }
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: wm, body: ['Suscribete en el canal de YouTube ✨', 'Unete al canal de WhatsApp', wm].getRandom(), thumbnail: menusImgs4, sourceUrl: channel }}}}, tg)
