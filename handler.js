...
this.sendMessage(m.chat, {text: `❮💰❯ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝘽𝙤𝙩𝘾𝙤𝙞𝙣𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘉𝘰𝘵', previewType: 0, thumbnail: menuImgs1, sourceUrl: Allnz }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `❮💎❯ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝘿𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤. 𝙋𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙢𝙖𝙨 𝙙𝙞𝙖𝙢𝙖𝙣𝙩𝙚𝙨, 𝙪𝙨𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyall*\n*${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘉𝘰𝘵', previewType: 0, thumbnail: menuImgs1, sourceUrl: Allnz }}}, { quoted: m })         
continue
}

if (!isPrems && plugin.exoticocoins && global.db.data.users[m.sender].exoticocoins < plugin.exoticocoins * 1) {
this.sendMessage(m.chat, {text: `❮☁️❯ 𝙉𝙤 𝙩𝙞𝙚𝙣𝙚𝙨 𝙨𝙪𝙛𝙞𝙘𝙞𝙚𝙣𝙩𝙚𝙨 𝙎𝙚𝙧𝙫𝙚𝙧𝘾𝙤𝙞𝙣𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤. 𝙋𝙖𝙧𝙖 𝙘𝙤𝙢𝙥𝙧𝙖𝙧 𝙢𝙖𝙨 𝙨𝙚𝙧𝙫𝙚𝙧𝙘𝙤𝙞𝙣𝙨, 𝙪𝙨𝙚 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤.\n\n• 𝙋𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤:\n\n*${usedPrefix}buyallcoins*\n*${usedPrefix}buycoins*\n\n• 𝙑𝙞𝙨𝙞𝙩𝙖 𝙡𝙖 𝙩𝙞𝙚𝙣𝙙𝙖 𝙚𝙣: #tiendaexotico`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘉𝘰𝘵', previewType: 0, thumbnail: menuImgs1, sourceUrl: Allnz }}}, { quoted: m })         
continue
}
...
this.sendMessage(m.chat, {text: `❮📣❯ 𝙍𝙚𝙦𝙪𝙞𝙚𝙧𝙚𝙨 𝙚𝙡 𝙣𝙞𝙫𝙚𝙡: *${plugin.level}*\n\n• 𝙏𝙪 𝙣𝙞𝙫𝙚𝙡 𝙖𝙘𝙩𝙪𝙖𝙡 𝙚𝙨: *${_user.level}*\n\n• 𝙐𝙨𝙖 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙥𝙖𝙧𝙖 𝙨𝙪𝙗𝙞𝙧 𝙙𝙚 𝙣𝙞𝙫𝙚𝙡:\n*${usedPrefix}levelup*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘉𝘰𝘵', previewType: 0, thumbnail: menuImgs1, sourceUrl: Allnz }}}, { quoted: m })         
continue
}
let extra = {
match,
...
if (m.exoticocoins)
m.reply('❮☁️❯  𝙂𝙖𝙨𝙩𝙖𝙨𝙩𝙚 ' + m.exoticocoins + ' 𝙙𝙚 𝙎𝙚𝙧𝙫𝙚𝙧𝘾𝙤𝙞𝙣𝙨(𝙨)')

if (m.exoticoserver)
m.reply('❮🔑❯  𝘾𝙤𝙢𝙥𝙧𝙖𝙨𝙩𝙚 ' + m.exoticoserver + ' 𝙙𝙚 𝙎𝙚𝙧𝙫𝙞𝙙𝙤𝙧(𝙚𝙨)')

if (m.exoticopaquete)
m.reply('❮🪐❯  𝘼𝙗𝙧𝙞𝙨𝙩𝙚 ' + m.exoticopaquete + ' 𝙋𝙖𝙦𝙪𝙚𝙩𝙚.')
}
if (m.money)
...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|naufrazapp|naufra|naufrago|na|ho|qu|a|ja|js|mente|pero|tion|age|ous|ate|and|but|ify)/gi)) {
...
"thumbnail": apii.data, 
"title": [wm, packname, '𝙉𝙖𝙪𝙛𝙧𝙖𝙕𝙖𝙥𝙥-𝙈𝘿'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: Allnz }}}, { quoted: fkontak2 })
apii.data = ''
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '🔗 • 𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼 • 🔗', body: [wm, packname, '𝘕𝘢𝘶𝘧𝘳𝘢𝘡𝘢𝘱𝘱-𝘔𝘋'].getRandom(), thumbnail: menuImgs1, sourceUrl: Allnz }}}}, tg)
